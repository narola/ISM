    ...
    */
    public function getBooksForUser($postData)
    {
        ...
        $limit2 = addslashes($limit2);*/
         ...
         " users ON users.id=autotBook.user_id) authorBookJoin ON authorBookJoin.book_id=book.id ORDER BY book.id DESC LIMIT 30";
        ...
        $resultQuery=mysql_query($selectQuery) or $message=mysql_error();
         ...
         INNER JOIN(SELECT authorBook.user_id,authorBook.book_id,users.full_name,users.profile_pic from ".TABLE_AUTHOR_BOOK." authorBook INNER JOIN ".TABLE_USERS.
    ...
    */
    ...
    public function getPastimeForUser($postData)
    {
        ...
        $user_id = addslashes($user_id);
         ...
         $selectQuery="select id as 'pastime_id',pastime_name,pastime_image from ".TABLE_PASTIMES." ORDER BY id DESC LIMIT 30";
         $resultQuery=mysql_query($selectQuery) or $message=mysql_error();
    ...
    */
    public function getRoleModelForUser($postData)
    {
        ...
        $user_id = addslashes($user_id);
         ...
         from ".TABLE_ROLE_MODELS." ORDER BY id DESC LIMIT 30";
         $resultQuery=mysql_query($selectQuery) or $message=mysql_error();
    ...
    */
    public function getMoviesForUser($postData)
    {
        ...
        $user_id = addslashes($user_id);
         ...
         $selectQuery="SELECT id as 'movie_id',movie_name,movie_image,genres as 'movie_genre',description,screenplay from ".TABLE_MOVIES." ORDER BY id DESC LIMIT 30";
         $resultQuery=mysql_query($selectQuery) or $message=mysql_error();
