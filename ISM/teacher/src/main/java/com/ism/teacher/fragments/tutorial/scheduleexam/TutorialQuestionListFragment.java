...
import com.ism.teacher.adapters.tutorial.TutorialQuestionBankListAdapter;
...
public class TutorialQuestionListFragment extends Fragment implements WebserviceWrapper.WebserviceResponse, View.OnClickListener {


    private static final String TAG = TutorialQuestionListFragment.class.getSimpleName();
    private View view;
    Fragment mFragment;

    public TutorialQuestionListFragment() {
    }

    public TutorialQuestionListFragment(Fragment fragment) {
    ...
    //Adapter Class
    private TutorialQuestionBankListAdapter questionBankListAdapter;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_tutorial_questionlist, container, false);
    ...
    private void initGlobal() {
        ...
        questionBankListAdapter = new TutorialQuestionBankListAdapter(getActivity(), mFragment);
        ...
        try {
            ...
            if (object != null) {
                ...
                if (responseHandler.getStatus().equals(ResponseHandler.SUCCESS)) {
                    ...
                    if (getScheduleTutorialContainerFragment().getBundleArguments() != null) {
                        Debug.e(TAG, "THE SUBJECT NAME IS" + getScheduleTutorialContainerFragment().getBundleArguments().getString(AssignmentsAdapter.ARG_EXAM_SUBJECT_NAME));
                        spQuestionlistSubject.setSelection(subjects.indexOf(getScheduleTutorialContainerFragment().getBundleArguments().getString(AssignmentsAdapter.ARG_EXAM_SUBJECT_NAME)));
                    }
        ...
        try {
            ...
            if (object != null) {
                ...
                if (responseHandler.getStatus().equals(ResponseHandler.SUCCESS)) {
                    ...
                    Debug.e(TAG,"num of total question in bank "+responseHandler.getQuestionBanks().size());

                    for(Questions allQuestions: responseHandler.getQuestionBanks())
                    {
                        if(allQuestions.getQuestionFormat().equalsIgnoreCase("MCQ"))
                        {
                            arrListQuestions.add(allQuestions);
                        }
                    }

                    Debug.e(TAG, "num of mcq question" + arrListQuestions.size());
                ...
                Debug.e(TAG, "onResponseGetQuestionBank api Exception : " + error.toString());
            }
        } catch (Exception e) {
            Debug.e(TAG, "onResponseGetQuestionBank Exception : " + e.toString());
        }
    }
