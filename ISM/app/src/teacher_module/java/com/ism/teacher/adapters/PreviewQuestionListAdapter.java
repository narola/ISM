    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.imgPreviewQuestionDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              //  ((AddQuestionFragmentTeacher) mFragment).questionListFragment.updateViewAfterDeleteInPreviewQuestion(listOfPreviewQuestions,position);
               ...
               // ((AddQuestionFragmentTeacher) mFragment).questionListFragment.updateViewAfterDeleteInPreviewQuestion(position);
