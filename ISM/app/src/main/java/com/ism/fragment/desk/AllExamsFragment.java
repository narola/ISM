 ...
 */
public class AllExamsFragment extends Fragment implements WebserviceWrapper.WebserviceResponse{

    private static final String TAG = AllExamsFragment.class.getSimpleName();
    private View view;
    ...
    private void initGlobal() {
        ...
        recyclerView.setAdapter(favExamsAdapter);
