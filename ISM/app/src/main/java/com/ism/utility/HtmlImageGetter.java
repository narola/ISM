    ...
    public Drawable getDrawable(String source) {
        ...
        if (source.startsWith("http") || source.startsWith("https:")) {
            try {
                ...
                Log.e(TAG, mContext.getString(R.string.strImageNotFoundChecktheImageUrl), error);
            }
        } else {
            try {
                ...
                Log.e(TAG, mContext.getString(R.string.strImageNotFoundCheckTheID), error);
            }
        }
