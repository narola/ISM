...
//                        responseObject = new WSRequestPost(WebConstants.URL_LOGIN, ResponseLogin.class, attribute);
                    ...
                    case WebConstants.GENERAL_SETTING_PREFERENCES:
                        responseObject = new WSRequestPost(WebConstants.URL_GENERAL_SETTING_PREFERENCES).execute(ResponseHandler.class, attribute);
                        break;
                    case WebConstants.GET_USER_PREFERENCES:
                        responseObject = new WSRequestPost(WebConstants.URL_USER_PREFERENCES).execute(ResponseHandler.class, attribute);
                        break;
...
//                        break;
                    case WebConstants.GET_ABOUT_ME:
                        responseObject = new WSRequestPost(WebConstants.URL_GET_ABOUT_ME).execute(ResponseHandler.class, attribute);
                        break;
                    ...
                    case WebConstants.EDIT_ABOUT_ME:
                        responseObject = new WSRequestPost(WebConstants.URL_EDIT_ABOUT_ME).execute(ResponseHandler.class, attribute);
                        break;
                    ...
                    case WebConstants.GET_BOOKS_FOR_USER:
                        responseObject = new RequestWs().getRequest(WebConstants.URL_GET_BOOKS_FOR_USER, ResponseHandler.class, attribute);
                        break;
                }
            } catch (Exception e) {
