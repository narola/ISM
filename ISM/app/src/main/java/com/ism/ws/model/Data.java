...
public class Data {
    ...
    private ArrayList<Data> preferences;
    private ArrayList<Data> privacySetting;
...
//    }
    ...
    public ArrayList<Data> getPreferences() {
        return preferences;
    }

    public void setPreferences(ArrayList<Data> preferences) {
        this.preferences = preferences;
    }

    @JsonProperty("Privacy_Setting")
    public ArrayList<Data> getPrivacySetting() {
        return privacySetting;
    }

    public void setPrivacySetting(ArrayList<Data> privacySetting) {
        this.privacySetting = privacySetting;
    }

    @JsonProperty("Notification")
    public ArrayList<Data> getNotification() {
        return notification;
    }

    public void setNotification(ArrayList<Data> notification) {
        this.notification = notification;
    }

    @JsonProperty("SMS_Alert")
    public ArrayList<Data> getSmsAlert() {
        return smsAlert;
    }

    public void setSmsAlert(ArrayList<Data> smsAlert) {
    ...
    public void setBlockedList(ArrayList<Data> blockedList) {
