 ...
 */
public class AcceptTutorialGroupAdapter extends BaseAdapter {

    private static final String TAG = AcceptTutorialGroupAdapter.class.getSimpleName();

    private Context context;
    private LayoutInflater inflater;
	private MyTypeFace myTypeFace;

    public AcceptTutorialGroupAdapter(Context context) {
