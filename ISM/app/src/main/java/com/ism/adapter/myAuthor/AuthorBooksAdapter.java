...
public class AuthorBooksAdapter extends RecyclerView.Adapter<AuthorBooksAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(context).inflate(R.layout.row_author_book, parent, false);
...
//                    }
                    if (holder.imgLibraryBook.isActivated()) {
                        holder.imgLibraryBook.setActivated(false);
                    } else {
                        holder.imgLibraryBook.setActivated(true);
                    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            imgFav = (ImageView) itemView.findViewById(R.id.img_add_fav);
