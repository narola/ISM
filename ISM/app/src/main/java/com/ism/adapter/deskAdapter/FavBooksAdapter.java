...
public class FavBooksAdapter extends RecyclerView.Adapter<FavBooksAdapter.ViewHolder> {
    ...
    public FavBooksAdapter(Context context, ArrayList<BookData> arrayList, HostActivity.BooksListner booksListner) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(context).inflate(R.layout.item_book, parent, false);
