...
import com.ism.utility.HtmlImageGetter;
...
public class PastQuestionsAdapter extends RecyclerView.Adapter<PastQuestionsAdapter.ViewHolder> implements HtmlImageGetter.RefreshDataAfterLoadImage {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.row_past_trending_questions, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        try {
            ...
            Global.imageLoader.displayImage(WebConstants.HOST_IMAGE_USER + arrayList.get(position).getPostedByPic(), holder.imgDpPostCreator, ISMStudent.options);
...
//            holder.txtAnswer.setText(Html.fromHtml(arrayList.get(position).getAnswerText()));
            ...
            holder.llMain.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((HostActivity) context).loadFragment(MyAuthorFragment.FRAGMENT_PAST_TRENDING_QUESTION_DETAIL,null);
                }
            });
    ...
    public void setBundleArgument(String questionId) {
        ((HostActivity)context).getBundle().putString(PastQuestionsAdapter.ARG_QUESTION_ID, questionId);
    }
