...
public class ViewProfileFragment extends Fragment {
    ...
    public static ViewProfileFragment newInstance() {
        ViewProfileFragment fragBooks = new ViewProfileFragment();
        return fragBooks;
    }
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            ...
            if (fragListener != null) {
                fragListener.onFragmentAttached(AuthorHostActivity.FRAGMENT_VIEW_PROFILE);
            }
    ...
    public void onDetach() {
        ...
        try {
            if (fragListener != null) {
                fragListener.onFragmentDetached(AuthorHostActivity.FRAGMENT_VIEW_PROFILE);
            }
        } catch (ClassCastException e) {
