...
public class BlockedUserAdapter extends BaseAdapter implements WebserviceWrapper.WebserviceResponse {
    ...
    private final AuthorHostActivity.ResizeView resizeView;
    Context context;
    LayoutInflater inflater;
    private int blockUserPosition =-1;

    public BlockedUserAdapter(Context context, ArrayList<BlockedUsers> arrayList, AuthorHostActivity.ResizeView resizeView) {
