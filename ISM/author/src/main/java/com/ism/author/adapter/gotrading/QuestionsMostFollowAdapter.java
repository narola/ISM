...
public class QuestionsMostFollowAdapter extends RecyclerView.Adapter<QuestionsMostFollowAdapter.ViewHolder> {
    ...
    public QuestionsMostFollowAdapter(Context context, ArrayList<String> arrayList) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        if(getBundleArguments().containsKey(QuestionsMostFollowAdapter.ARG_QUESTION_ID)) {
            if (getBundleArguments().getInt(QuestionsMostFollowAdapter.ARG_QUESTION_ID) == position) {
    ...
    public void setBundleArgument(int position) {
        getBundleArguments().putInt(QuestionsMostFollowAdapter.ARG_QUESTION_ID, position);
