...
public class AppConstant {
    ...
    public static final String FRAGMENT_PAST_TRENDING_QUESTIONS = "fragmentPastTrendingQuestions";
    public static final String FRAGMENT_TRENDING_QUESTION_DETAIL = "fragmentTrendingQuestionDetail";
