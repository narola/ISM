 ...
 * Relationship with {@link ROCourseCategory}
 */
public class ROCourses extends RealmObject {
    @PrimaryKey
    ...
    private ROCourseCategory roCourseCategory;
    ...
    public ROCourseCategory getRoCourseCategory() {
        return roCourseCategory;
    }

    public void setRoCourseCategory(ROCourseCategory roCourseCategory) {
        this.roCourseCategory = roCourseCategory;
    }
}
