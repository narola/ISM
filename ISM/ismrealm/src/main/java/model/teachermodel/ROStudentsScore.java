 ...
 */
public class ROStudentsScore extends RealmObject{
    ...
    private RealmList<ROSubjectWiseScore> roSubjectWiseScore;
    ...
    public RealmList<ROSubjectWiseScore> getRoSubjectWiseScore() {
        return roSubjectWiseScore;
    }

    public void setRoSubjectWiseScore(RealmList<ROSubjectWiseScore> roSubjectWiseScore) {
        this.roSubjectWiseScore = roSubjectWiseScore;
    }
