...
class Subject extends ADMIN_Controller {
    ...
    public function lists() {
        ...
        if (!empty($_GET['q'])) {
            ...
            if (!empty($q)) {
                $where['like'][TBL_SUBJECTS . '.subject_name'] = $q;
                $str .='&q=' . $q;
            }
            ...
            if (!empty($str)) {
                ...
                $config['base_url'] = base_url() . 'admin/subject/lists';
            }
        ...
        $this->data['all_subjects'] = select(TBL_SUBJECTS, TBL_SUBJECTS . '.id,' . TBL_SUBJECTS . '.subject_name,' . TBL_SUBJECTS . '.subject_image,', $where, array(
    ...
    public function update_subject($id) {
        ...
        $this->data['subject'] = select(TBL_SUBJECTS, TBL_SUBJECTS . '.id,'
                ...
                . TBL_COURSES . '.id,'
                . TBL_COURSES . '.course_name', array(
            'where' => array(TBL_SUBJECTS . '.id' => $id)), array(
            'single' => TRUE,
            'join' => array(
                array(
