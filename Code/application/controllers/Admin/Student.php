...
class Student extends ADMIN_Controller {
	...
	public function index() {
		...
		if(!empty($_GET['course']) || !empty($_GET['school']) || 
			...
			if(!empty($str)) { $config['base_url']	 = base_url().'admin/student/index?'.$str; }else{ $config['base_url'] = base_url().'admin/student/index';  }
			...
			$config['base_url']	 = base_url().'admin/student/index';
		...
		$this->template->load('admin/default','admin/student/view_user',$this->data);
	}
	...
	public function add(){
		...
		if($this->form_validation->run() == FALSE){
			...
			$this->template->load('admin/default','admin/student/add_user',$this->data);
	...
	public function update($id){
		...
		if($this->form_validation->run() == FALSE){
			...
			$this->template->load('admin/default','admin/student/update_user',$this->data);
	...
	public function send_message($id){
		...
		if($this->form_validation->run() == FALSE){
			...
			$this->template->load('admin/default','admin/student/send_message',$this->data);
		}else{
			...
			if($cnt != 0){
				...
				redirect('admin/student/send_message/'.$id);
			}
...
$this->data['is_scl'] = 0;
		...
		if($this->form_validation->run() == FALSE){
			...
			$this->template->load('admin/default','admin/student/send_messages',$this->data);	
			...
			if($cnt != 0){
				$this->session->set_flashdata('msgerror', 'Message template should be Unique.');
				redirect('admin/student/send_messages');
			}
	...
	public function activity($id)
	{
		...
		$this->template->load('admin/default','admin/student/my_activities',$data);
	}	
