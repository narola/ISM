    ...
    <div class="row">
        ...
        <div class="col-sm-4 group_performance_3 general_cred">
            ...
            <div class="performance_div mCustomScrollbar" data-mcs-theme="minimal-dark">
                ...
                <div class="box_header">
                    <h3>Teachers Allocated</h3>
                </div>
                <div class="allocated_teachers">
                    <!--teacher1-->
                    <div class="stm_item">
                        <a href="#">
                            <div class="stm_user_img">
                                <img src="../images/user7.jpg" onerror="this.src='<?php echo base_url() ?>assets/images/avatar.png'">
                            </div>
                            <p class="teacher_name">Mary Watson</p>
                            <p>Works at LNHS</p>
                            <p>Assigned 3 Exams</p>
                        </a>
                        <div class="clearfix"></div>
                    </div>
                    <!--//teacher1-->
                    ...
                    <div class="stm_item">
                        <a href="#">
                            <div class="stm_user_img">
                                <img src="../images/user6.jpg" onerror="this.src='<?php echo base_url() ?>assets/images/avatar.png'">
                            </div>
                            <p class="teacher_name">Mary Watson</p>
                            <p>Works at LNHS</p>
                            <p>Assigned 3 Exams</p>
                    ...
                    <div class="stm_item">
                        <a href="#">
                            <div class="stm_user_img">
                                <img src="../images/user5.jpg" onerror="this.src='<?php echo base_url() ?>assets/images/avatar.png'">
                            </div>
                            <p class="teacher_name">Mary Watson</p>
                            <p>Works at LNHS</p>
                            <p>Assigned 3 Exams</p>
                    ...
                    <div class="stm_item">
                        <a href="#">
                            <div class="stm_user_img">
                                <img onerror="this.src='<?php echo base_url() ?>assets/images/avatar.png'" src="../images/user4.jpg">
                            </div>
                            <p class="teacher_name">Mary Watson</p>
                            <p>Works at LNHS</p>
                            <p>Assigned 3 Exams</p>
                    ...
                    <div class="stm_item">
                        <a href="#">
                            <div class="stm_user_img">
                                <img  onerror="this.src='<?php echo base_url() ?>assets/images/avatar.png'" src="../images/user3.jpg">
                            </div>
                            <p class="teacher_name">Mary Watson</p>
                            <p>Works at LNHS</p>
                            <p>Assigned 3 Exams</p>
                    ...
                    <div class="stm_item">
                        <a href="#">
                            <div class="stm_user_img">
                                <img  onerror="this.src='<?php echo base_url() ?>assets/images/avatar.png'" src="../images/user2.jpg">
                            </div>
                            <p class="teacher_name">Mary Watson</p>
                            <p>Works at LNHS</p>
                            <p>Assigned 3 Exams</p>
                    ...
                    <div class="stm_item">
                        <a href="#">
                            <div class="stm_user_img">
                                <img onerror="this.src='<?php echo base_url() ?>assets/images/avatar.png'" src="../images/user1.jpg">
                            </div>
                            <p class="teacher_name">Mary Watson</p>
                            <p>Works at LNHS</p>
                            <p>Assigned 3 Exams</p>
