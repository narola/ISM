            ...
            <div class="col-sm-12 general_cred">
                ...
                <div class="box">
                    <div class="box_header filter">
                        <h3><?php $copy = $this->uri->segment(3); if($copy == 'copy'){ echo "Copy"; }else{ echo "Update"; }?> Question</h3>
                    </div>
                    ...
                    <div class="box_body add_question_wrapper admin_controls with_labels">
                        ...
                        <div class="col-sm-12" id="replacing_div3">
                            ...
                            <?php 
                                if(!$_POST || $_POST['total_choices'] == 1) { 

                            ?>

                            
                            <input type="hidden" name='total_choices' id="total_choices" value="<?php echo $choice_count; ?>"  >
                            <input type="hidden" name='correct_choice' id="correct_choice" value="<?php echo $choice_count-1; ?>" >
                ...
                <input type="radio" name="correct_ans" id="correct_ans" <?php if($choice['is_right']=='1'){ echo 'checked'; } ?> 
                onchange="correct_choice1(this.value)" value="<?php echo $i; ?>" >

                <input type="text" name="choices[]" class="form-control choice_detail" value="<?php echo $choice['choice_text']; ?>"
                ...
                <input type="text" name="choices[]" class="form-control choice_detail" value="<?php echo $_POST['choices'][$j]; ?>"
                                    ...
                                    <select multiple="multiple" name="q_tags[]" id="my_select" class="form-control">
                                           ...
                                           <?php if(!empty($tags)) { foreach($tags as $tag) { ?>
                                                <option value="<?php echo $tag['id']; ?>" 
                                                    ...
                                                    <?php if(in_array($tag['id'],$que_tags)){ echo 'selected="selected"'; }   ?>    
                                                    >
                    ...
                    <div class="box_footer">
                        ...
                        <button class="btn btn_red pull-right" onclick="set_hidden('save')" > 
