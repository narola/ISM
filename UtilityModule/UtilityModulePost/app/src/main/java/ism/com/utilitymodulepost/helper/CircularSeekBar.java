package ism.com.utilitymodulepost.helper;
...
public class CircularSeekBar extends View {
    ...
    protected static final int POINTER_PROGRESS_START=Color.BLACK;
    /**
    ...
    private Paint mPointerPaintFixed;
    ...
    protected void initPaints() {
        ...
        mPointerPaintFixed = new Paint();
        mPointerPaintFixed.setAntiAlias(true);
        mPointerPaintFixed.setDither(true);
        mPointerPaintFixed.setStyle(Paint.Style.FILL);
        mPointerPaintFixed.setColor(Color.BLACK);
        mPointerPaintFixed.setStrokeWidth(mPointerRadius);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(initial){
            canvas.drawCircle(mPointerPositionXY[0], mPointerPositionXY[1], mPointerRadius, mPointerPaintFixed);
            initial=false;
        }
