package com.narola.c161.whiteboard.view;
...
import com.narola.c161.whiteboard.adapter.PointerAdapter;
import com.narola.c161.whiteboard.utility.ColorPickerDialog;

public class Whiteboard extends LinearLayout implements ColorPickerDialog.OnColorPickerListener {
    ...
    public interface WhiteboardListener {
        void onSendImageListener(Bitmap bitmap);
    }
    ...
    protected void onFinishInflate() {
        ...
        mImageColorPicker.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new ColorPickerDialog(mContext, Whiteboard.this, mWhiteboardView.getPaintColor()).show();
            }
        });
